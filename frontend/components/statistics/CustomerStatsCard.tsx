  ...
  return (
    <div className="chart-container">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-sm font-bold text-white">Customer Stats</h3>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        ...
        <div className="text-center p-2 bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-lg border border-purple-400/30">
          ...
          <div className="text-xs font-medium text-white">New This Month</div>
        </div>
      </div>

      <div>
        <h4 className="text-sm font-semibold mb-3 text-white">Top Customers 👑</h4>
            ...
            <div key={customer.id} className="flex items-center justify-between p-2 bg-white/5 hover:bg-white/10 rounded-lg transition-all duration-200">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-xs text-white">{customer.requestCount} requests</div>
                </div>
              </div>
