          ...
          >
            <button 
              ...
              style={{
                ...
                border: 'none',
                borderRadius: '8px',
                background: isSubmitting || !formData.code.trim() || !formData.name.trim() 
                  ? '#9ca3af' 
                  : 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)',
                color: 'white',
                fontSize: '14px',
                fontWeight: '600',
                cursor: isSubmitting || !formData.code.trim() || !formData.name.trim() 
                  ? 'not-allowed' 
                  : 'pointer',
                transition: 'all 0.2s ease',
                boxShadow: isSubmitting || !formData.code.trim() || !formData.name.trim() 
                  ? 'none' 
              ...
              onMouseOver={(e) => {
                if (!isSubmitting && formData.code.trim() && formData.name.trim()) {
