// Edit Shipping Line Modal component
...
interface EditShippingLineModalProps {
  ...
  language: 'vi' | 'en';
  translations: any;
  originalCode: string; // Original code to check for duplicates
}
    ...
    <div className="modal-overlay" onClick={onCancel}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{width: '500px', maxWidth: '90vw'}}>
        <div className="modal-header">
          <h3 className="modal-title">{translations[language].editShippingLine}</h3>
