...
interface LowerGateHistoryProps {
  // No props needed
}

export default function LowerGateHistory({}: LowerGateHistoryProps) {
  ...
  const fetchHistory = async (useDebouncedValues = false) => {
    try {
      ...
      // Chỉ lấy dữ liệu cho IMPORT (Hạ container)
      params.append('type', 'IMPORT');
      ...
      <div className="page-header modern-header">
        <div className="header-content">
          <div className="header-left">
            <h1 className="page-title gradient gradient-ultimate">Lịch sử ra vào cổng - Hạ Container</h1>
          </div>
        ...
        {loading ? (
          ...
          <div className="empty-state" style={{
            ...
            <p style={{
              ...
              Không tìm thấy lịch sử xe hạ container ra vào cổng nào
            </p>
          </div>
        ) : (
          <>
            <div className="table-header" style={{
              ...
              <h3 style={{
                ...
                Danh sách xe hạ container đã ra khỏi cổng ({pagination.total} xe)
              </h3>
            </div>
