...
export const CreateSealModal: React.FC<CreateSealModalProps> = ({
	...
	// Removed existing seals check since we allow multiple seals per shipping line
	...
	// Removed loadExistingSeals since we no longer check for duplicates
	...
	// Filter data based on search terms (allow all shipping lines)
									...
									<div className="custom-dropdown-list">
										...
										{filteredShippingLines.length > 0 ? (
											...
											<div className="custom-dropdown-no-results">
												{shippingLineSearch ? 'Không tìm thấy hãng tàu nào' : 'Không có hãng tàu nào'}
											</div>
										)}
									</div>
								)}
