...
router.patch('/:id/disable', requireRoles('SystemAdmin','TechnicalDepartment'), (req, res) => controller.disable(req as any, res));
router.patch('/:id/enable', requireRoles('SystemAdmin','TechnicalDepartment'), (req, res) => controller.enable(req as any, res));
